...
private:
    ...
    process_get(const std::shared_ptr<message> &request, const std::shared_ptr<client_connection> &client_connection);

    static std::shared_ptr<message>
    process_ping(const std::shared_ptr<message> &request, const std::shared_ptr<client_connection> &client_connection);

    std::shared_ptr<message> process_get_lobbies_list(const std::shared_ptr<message> &request,
                                                      const std::shared_ptr<client_connection> &client_connection);

    std::shared_ptr<message> process_get_lobby_state(const std::shared_ptr<message> &request,
                                                     const std::shared_ptr<client_connection> &client_connection);

    //Post requests
    std::shared_ptr<message>
    process_post(const std::shared_ptr<message> &request, const std::shared_ptr<client_connection> &client_connection);

    static std::shared_ptr<message> process_handshake(const std::shared_ptr<message> &request,
                                                      const std::shared_ptr<client_connection> &client_connection);
    ...
    std::shared_ptr<message> process_lobby_exit(const std::shared_ptr<message> &request,
                                                const std::shared_ptr<client_connection> &client_connection);
